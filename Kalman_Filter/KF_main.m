...
TRN_coords_pre = load('april5_trnOutput');
TRN_coords = TRN_coords_pre.coords_vec_x;
...
TRN_coord_m(:,1) = TRN_coords(:,4).*cx;
TRN_coord_m(:,2) = TRN_coords(:,5).*cy;
...
TRN_coord_x_2(:,1) = downsample(TRN_coord_m(:,1),5);
